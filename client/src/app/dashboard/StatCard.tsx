...
const StatCard = ({
    ...
    return (
        <div className="bg-white md:row-span-1 xl:row-span-2 shadow-md col-span-1 rounded-2xl flex flex-col justify-around">
            {/* HEADER */}
            <div>
                            ...
                            <div className='flex item-center justify-between my-4'>
                                ...
                                <div className='flex items-center'>
                                    <detail.IconComponent 
                                        className={`w-4 h-4 ${getChangeColor(detail.changePercentage)}`} />
                                </div>
